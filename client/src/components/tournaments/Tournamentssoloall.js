...
const Tournamentssoloall = ({ getTournaments, tournament: { tournaments, loading } }) => {
    window.scrollTo(0, 0);
        ...
        <Fragment>
            ...
            <div className="profiles">
                {tournaments.solo.length > 0 ? (
                    tournaments.solo.map(tournament => (
...
export default connect(mapStateToProps, { getTournaments })(Tournamentssoloall);